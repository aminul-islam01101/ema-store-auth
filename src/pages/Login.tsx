...
const Login = () => (
    <div className="grid min-h-90v place-items-center ">
        <div className="w-full max-w-md space-y-3 rounded-xl p-8 dark:dark:bg-gray-900 dark:dark:text-gray-100">
            ...
            <form action="" className="ng-untouched ng-pristine ng-valid space-y-6">
                ...
                <input
                    type="submit"
                    className="block w-full rounded-sm p-3 text-center dark:dark:bg-violet-200 dark:dark:text-gray-900"
                    value="Login"
                />
            </form>
            <div className="flex items-center space-x-1 pt-4">
                <div className="h-px flex-1 dark:dark:bg-gray-700 sm:w-16" />
                <p className="px-3 text-sm dark:dark:text-gray-400">Login with social accounts</p>
                <div className="h-px flex-1 dark:dark:bg-gray-700 sm:w-16" />
            </div>
            <div className="flex justify-center space-x-4">
                ...
                <button type="button" aria-label="Log in with Facebook" className="rounded-sm p-3">
                    <FaFacebook />
                </button>
            </div>
